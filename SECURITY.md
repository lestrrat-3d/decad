...
decad is a headless CAD engine. Because it is designed to consume geometry and
documents that may be authored by an automated agent, the primary security
concern is **crafted input** — a malformed or hostile document, mesh, profile or
parameter that reaches the public API and causes a denial of service (unbounded
