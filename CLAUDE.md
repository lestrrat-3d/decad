...
| `loft_build.go` | `docs/loft-design.md` PR 1a/2a: `loftPayload`, `evalLoft` and `placed` — Table P pairing, the Table S gates it owns, the flat-triangle wall/cap construction, the placement re-lift and its `delta`, and the four measurements. See doc comments; `docs/loft-design.md` §5, §5.1, §5.2, §7, §8, §12. |
