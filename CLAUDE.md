...
| `spline_sagitta.go` | `docs/spline-design.md` §6.2.1's control-point-to-chord-segment sagitta bound (`spanSagittaUpper`) and `pairStations`, the shared dyadic station generator a same-kind free-form loft pairing composes. |
