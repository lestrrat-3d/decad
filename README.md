...
| <img src="docs/images/features/sweep.png" alt="A rectangular beam bent through a quarter-circle spatial path" width="320"><br>**Sweep** moves one solved profile along a spatial line or circular arc. | <img src="docs/images/features/loft.png" alt="A transition duct narrowing from a large rectangle to a smaller offset one" width="320"><br>**Loft** rules a wall between two profiles on different planes. |
...
| <img src="docs/images/features/verify.png" alt="A round pin standing inside a larger bore, clearance visible all the way round" width="320"><br>**Verify** proves the gap between two bodies, so a fit is checked before anything is cut. | |
